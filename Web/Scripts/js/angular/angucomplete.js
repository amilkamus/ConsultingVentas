    ...
    .directive('angucomplete', function ($parse, $http, $sce, $timeout) {
        return {
            ...
            template: '<div class="angucomplete-holder row">' +
                            ...
                            '<a ng-show="addElement" data-toggle="modal" data-target="#{{modal}}" class="btn btn-success btn-sm" ng-click="agregarArticulo(searchStr)"><span class="glyphicon glyphicon-plus"></span></a>' +
            ...
            link: function ($scope, elem, attrs) {
                ...
                $scope.agregarArticulo = function (nombre) {
