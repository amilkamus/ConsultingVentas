...
function _init() {
    ...
    $.AdminLTE.tree = function (a) {
        ...
        $(document).off("click", a + " li a").on("click", a + " li a",
            function (a) {
                var d = $(this),
                    e = d.next();
                if (e.is(".treeview-menu") && e.is(":visible") && !$("body").hasClass("sidebar-collapse"))
                    e.slideUp(c, function () { e.removeClass("menu-open") }),
...
$(function () {
    ...
    a.navbarMenuSlimscroll && "undefined" != typeof
    $.fn.slimscroll && $(".navbar .menu").slimscroll({
        height: a.navbarMenuHeight,
        alwaysVisible: !1, size: a.navbarMenuSlimscrollWidth
    }).css("width", "100%"),
...
function (a) {
    ...
    a.fn.boxRefresh = function (b) {
        ...
        var e = a.extend({
            trigger: ".refresh-btn",
            source: "",
            onLoadStart: function (a) { return a },
        ...
        return this.each(function () {
            ...
            f.on("click", function (a) {
                a.preventDefault(),
                c(b),
                b.find(".box-body").load(e.source, function () { d(b) })
            })
        })
    }
}(jQuery), function (a) {
