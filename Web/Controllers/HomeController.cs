...
namespace Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IEnumerable<NavBar> navbarItems()
        {
            ...
            menu.Add(new NavBar { Id = 6, Nombre = "Productos/Servicios", Icono = "fa fa-desktop", Estado = true, EsPadre = true, IdPadre = 0, Rol = 3 });
            ...
            menu.Add(new NavBar { Id = 9, Nombre = "Clientes", Icono = "fa fa-users", Estado = true, EsPadre = true, IdPadre = 0, Rol = 3 });
            ...
            menu.Add(new NavBar { Id = 12, Nombre = "Cotizacion", Icono = "fa fa-shopping-cart", Estado = true, EsPadre = true, IdPadre = 0, Rol = 3 });
            menu.Add(new NavBar { Id = 14, Nombre = "Listar Cotizacion", Controlador = "Cotizacion", Accion = "Index", Icono = "fa fa-circle-o", Estado = true, EsPadre = false, IdPadre = 12 });


            menu.Add(new NavBar { Id = 53, Nombre = "Orden de Servicio", Icono = "fa fa-shopping-cart", Estado = true, EsPadre = true, IdPadre = 0, Rol = 2 });
            ...
            menu.Add(new NavBar { Id = 15, Nombre = "Ventas", Icono = "fa fa-line-chart", Estado = true, EsPadre = true, IdPadre = 0, Rol = 2 });
            ...
            menu.Add(new NavBar { Id = 18, Nombre = "Nosotros", Icono = "fa fa-building", Estado = true, EsPadre = true, IdPadre = 0, Rol = 2 });
