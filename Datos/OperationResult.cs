...
namespace Datos
{
    public class OperationResult
    {
        ...
        public OperationResult(Exception e)
        {
            ...
            this.title = Properties.Settings.Default.OperationResultErrorDescription;
        ...
        public void setResult(OperationResultEnum result)
        {
            ...
            switch (result)
            {
                ...
                case OperationResultEnum.Success:
                    this.title = Properties.Settings.Default.OperationResultSuccessDescription;
                    break;
                case OperationResultEnum.Error:
                    this.title = Properties.Settings.Default.OperationResultErrorDescription;
                    break;
                case OperationResultEnum.Warning:
                    this.title = Properties.Settings.Default.OperationResultErrorDescription;
                    break;
